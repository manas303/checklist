...
export default (props) => { 
  ...
  return (
  <Popup className={styles.popup} trigger={ props.photo == undefined?<i className="fa fa-upload" aria-hidden="true"></i> :<div><img src={photoURL} width={"17px"}/></div>   } modal nested>
    {close => (
